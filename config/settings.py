"""
Django settings for EDF Concentrateur Tracker project.

Django 5.0+ with PostgreSQL, DRF, and security best practices.
"""
import os
...
#         'NAME': os.getenv('DB_NAME', 'edf_tracker'),
...
# CORS settings
CORS_ALLOWED_ORIGINS = os.getenv('CORS_ORIGINS', 'http://localhost:8000,http://127.0.0.1:8000,http://localhost:5173,http://127.0.0.1:5173').split(',')
